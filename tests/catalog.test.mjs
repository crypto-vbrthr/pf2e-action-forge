...
test("manifest identifies the dev.7 Treat Wounds build and release URLs", async () => {
  ...
  assert.equal(manifest.version, "0.1.0-dev.7.3");
  ...
  assert.equal(manifest.download, "https://github.com/crypto-vbrthr/pf2e-action-forge/releases/download/v0.1.0-dev.7.3/pf2e-action-forge.zip");
});
