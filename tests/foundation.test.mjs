...
test("manifest identifies the development build and Foundry/PF2e compatibility", async () => {
  ...
  assert.equal(manifest.version, "0.1.0-dev.1.4");
  ...
  assert.equal(manifest.download, "https://github.com/crypto-vbrthr/pf2e-action-forge/releases/download/v0.1.0-dev.1.4/pf2e-action-forge.zip");
...
test("repository release files are present", async () => {
  ...
  assert.match(changelog, /0\.1\.0-dev\.1\.4/);
